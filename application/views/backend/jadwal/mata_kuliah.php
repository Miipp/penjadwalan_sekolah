		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label>Kode Mapel <sup class="text-danger">*</sup></label>
							<input type="text" class="form-control" id="mk-kode" placeholder="Kode Mapel">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Nama Mapel <sup class="text-danger">*</sup></label>
							<input type="text" class="form-control" id="mk-nama" placeholder="Nama Mapel">
						</div>
					</div>
				</div>
			</div>
