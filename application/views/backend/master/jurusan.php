				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label>Nama Sekolah  <sup class="text-danger">*</sup></label>
							<input type="hidden" id="jurusan-id">
							<select class="form-control" id="fakultas-id">
								<option value="">--Pilih Sekolah</option>
								<?php foreach($fakultas as $i): ?>
									<option value="<?= $i->fakultas_id ?>"><?= $i->fakultas_nama ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="jurusan-nama" placeholder="Nama Jurusan">
						</div>
					</div>
				</div>
			</div>
