								...
								<table class="table table-bordered table-striped mytables" id="mydata-tables">
									<thead>
										<tr>
											...
											<th class="text-center">Jabfung</th>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<select class="form-control" id="prodi-id">
								<option value="">--Pilih Jurusan</option>
								<?php foreach($prodi as $i): ?>
									<option value="<?= $i->prodi_id ?>"><?= $i->prodi_nama ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="dosen-nip" placeholder="NIP">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Nama <sup class="text-danger">*</sup></label>
							<input type="text" class="form-control" id="dosen-nama" placeholder="Nama">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Jabatan Fungsional</label>
							<input type="text" class="form-control" id="dosen-jabfung" placeholder="Jabatan Fungsional">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Jabatan</label>
							<input type="text" class="form-control" id="dosen-jabatan" placeholder="Jabatan">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Golongan</label>
							<input type="text" class="form-control" id="dosen-golongan" placeholder="Golongan">
						</div>
					</div>
				</div>
			</div>
