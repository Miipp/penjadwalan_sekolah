								...
								<table class="table table-bordered table-striped mytables" id="mydata-tables">
									<thead>
										<tr>
											...
											<th class="text-center">Warna Prodi</th>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<select class="form-control" id="jurusan-id">
								<option value="">--Pilih Jurusan</option>
								<?php foreach($jurusan as $i): ?>
									<option value="<?= $i->jurusan_id ?>"><?= $i->jurusan_nama ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Nama Kelas  <sup class="text-danger">*</sup></label>
							<input type="text" class="form-control" id="prodi-nama" placeholder="Nama Prodi">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Warna Kelas  <sup class="text-danger">*</sup></label>
							<input type="color" class="form-control" id="prodi-warna" placeholder="Warna Prodi">
						</div>
					</div>
				</div>
			</div>
