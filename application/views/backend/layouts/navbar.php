	...
	<header class="main-header">
		<div class="inside-header clearfix">
			<nav class="main-nav" role="navigation">
				<h2 class="nav-brand"><a href="<?= base_url()?>"><img src="<?= images_url('sman1madang.png')?>" class="max-w-50" alt="Logo"></a></h2>
				...
				<ul id="main-menu" class="sm sm-blue">
					...
					<li><a href="#" class="<?= $groupTitle == 'Data Jadwal' ? 'current' : '' ?>"><i class="ti-files mx-5"></i>Data Jadwal</a>
						<ul>
							...
							<li><a href="<?= base_url('jadwal/mata-pelajaran')?>" class="<?= $title == 'Mata Pelajaran' ? 'current' : '' ?>">Mata Pelajaran</a></li>
						</ul>
					</li>
					<li><a href="#" class="<?= $groupTitle == 'Data Master' ? 'current' : '' ?>"><i class="ti-files mx-5"></i>Data Master</a>
						<ul>
							<li><a href="<?= base_url('master/fakultas')?>" class="<?= $title == 'Sekolah' ? 'current' : '' ?>">Sekolah</a></li>
							<li><a href="<?= base_url('master/jurusan')?>" class="<?= $title == 'Jurusan' ? 'current' : '' ?>">Jurusan</a></li>
							<li><a href="<?= base_url('master/kelas')?>" class="<?= $title == 'Kelas' ? 'current' : '' ?>">Kelas</a></li>
							<li><a href="<?= base_url('master/dosen')?>" class="<?= $title == 'Guru' ? 'current' : '' ?>">Guru</a></li>
					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="User">
								<img src="<?= images_url('account-icon.png')?>" class="user-image rounded-circle" alt="User Image">
							</a>
							<ul class="dropdown-menu animated flipInX">
								<li class="user-header bg-img" style="background-image: url('<?= backend_url('images/user-info.jpg')?>')" data-overlay="3">
									<div class="flexbox align-self-center">					  
										<img src="<?= images_url('account-icon.png')?>" class="float-left rounded-circle" alt="User Image">					  
